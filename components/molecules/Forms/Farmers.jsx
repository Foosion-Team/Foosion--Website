    ...
    <div>
       ...
       <form className='px-5 md:px-24 lg:px-28 pt-10'>
        <div className='xl:flex'>
          ...
          <div>
            <Input width='250px' type='text' placeholder='Farm Size' className='xl:ml-24' name='farmSize' onChange={handleChange} value={farmer.farmSize} />
          </div>
        ...
        <div className='xl:pt-10 xl:flex'>
          ...
          <Input width="450px" placeholder='Farm Location' className='xl:ml-24' name="farmLocation" onChange={handleChange} value={farmer.farmLocation}/>
        </div>
